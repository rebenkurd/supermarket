                            ...
                            <div class="card">
                                <div class="bootstrap-data-table-panel">
                                    <div class="table-responsive">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <button type="button" onclick="multiRecoveryOrder()" title="گەڕاندنەوە" class="btn btn-success"><i class="ti-reload"></i></button>
                                            </div>
                                        </div>
                                        <table class="table table-striped table-bordered" id="bootstrap-data-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="tr_order_<?php echo $order->id; ?>">
                                                    ...
                                                    ?></td>
                                                    <td>
                                                        <button type="button"  class="btn btn-danger " onclick="orderDelete(<?php echo $order->id; ?>)"
                                                        title="سڕینەوە">
